...
class CronConfig(models.Model):
    cron_second = models.CharField(max_length=10, verbose_name='分', default='0')
    cron_minute = models.CharField(max_length=10, verbose_name='分', default='*/5')
    ...
    cron_name = models.CharField(max_length=100, verbose_name='Cron名称', default='every 5 minute', unique=True)
